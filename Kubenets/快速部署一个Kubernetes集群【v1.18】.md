...
| 角色       | IP              |
| ---------- | --------------- |
| k8s-master | 192.168.201.130 |
| k8s-node1  | 192.168.201.131 |
| k8s-node2  | 192.168.201.132 |
...
在master添加hosts：
$ cat >> /etc/hosts << EOF
192.168.201.130 k8s-master
192.168.201.131 k8s-node1
192.168.201.1323 k8s-node2
EOF
...
在192.168.201.130（Master）执行。

```
$ kubeadm init \
  --apiserver-advertise-address=192.168.201.130 \
...
在192.168.201.131/132（Node）执行。

向集群添加新节点，执行在kubeadm init输出的kubeadm join命令：

```
$ kubeadm join 192.168.201.130:6443 --token esce21.q6hetwm8si29qxwn \
...
# kubeadm join 192.168.201.130:6443 --token nuja6n.o3jrhsffiqs9swnu --discovery-token-ca-cert-hash sha256:63bca849e0e01691ae14eab449570284f0c3ddeea590f8da988c07fe2729e924
```
